...
requireSrc();
var postcssCssVariables = { exports: {} };
var extend;
...
function requirePostcssCssVariables() {
  if (hasRequiredPostcssCssVariables) return postcssCssVariables.exports;
  ...
  postcssCssVariables.exports = (options = {}) => {
  ...
  postcssCssVariables.exports.postcss = true;
  return postcssCssVariables.exports;
}
requirePostcssCssVariables();
