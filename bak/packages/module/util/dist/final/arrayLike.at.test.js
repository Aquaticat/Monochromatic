...
// src/arrayLike.entries.ts
// @__NO_SIDE_EFFECTS__
async function* entriesArrayLikeAsync(arrayLike) {
  let i = 0;
...
__name(entriesArrayLikeAsync, "entriesArrayLikeAsync");
// @__NO_SIDE_EFFECTS__
function* entriesArrayLike(arrayLike) {
  let i = 0;
...
__name(entriesArrayLike, "entriesArrayLike");

// src/arrayLike.at.ts
// @__NO_SIDE_EFFECTS__
async function atArrayLikeAsync(index, arrayLike) {
...
__name(atArrayLikeAsync, "atArrayLikeAsync");
// @__NO_SIDE_EFFECTS__
function atArrayLike(index, arrayLike) {
  if (Array.isArray(arrayLike)) {
    return arrayLike.at(index);
  }
  const arrayLikeArray = [];
...
__name(atArrayLike, "atArrayLike");

// src/arrayLike.at.test.ts
...
function assertUndefined(actual) {
  /* @__PURE__ */ assert(void 0, actual);
}
__name(assertUndefined, "assertUndefined");
// @__NO_SIDE_EFFECTS__
function assert1(actual) {
  /* @__PURE__ */ assert(1, actual);
}
__name(assert1, "assert1");
...
//# sourceMappingURL=arrayLike.at.test.js.map
