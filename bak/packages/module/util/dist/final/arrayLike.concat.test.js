...
// src/function.nary.ts
// @__NO_SIDE_EFFECTS__
function unary(fn) {
  return /* @__PURE__ */ __name(function unaryfied(param1) {
    return fn(param1);
  }, "unaryfied");
}
__name(unary, "unary");

// src/arrayLike.concat.ts
// @__NO_SIDE_EFFECTS__
async function concatArrayLikesAsync(...arrayLikes) {
  const arrayOfArrays = await mapArrayLikeAsync(
    unary(arrayFromAsync),
    arrayLikes
  );
  return arrayOfArrays.flat();
}
__name(concatArrayLikesAsync, "concatArrayLikesAsync");
// @__NO_SIDE_EFFECTS__
function concatArrayLikes(...arrayLikes) {
  const arrayOfArrays = mapArrayLike(unary(arrayFrom), arrayLikes);
  return arrayOfArrays.flat();
}
__name(concatArrayLikes, "concatArrayLikes");
...
//# sourceMappingURL=arrayLike.concat.test.js.map
