import { type Ints, type MaybeAsyncIterable, type Tuple } from './arrayLike.ts';
...
export declare function chunksArrayLike<T_arrayLike extends Iterable<any> & {
    length: number;
...
export declare function chunksArrayLike<T_arrayLike extends Iterable<any>, T_n extends number>(arrayLike: T_arrayLike, n: T_n): Generator<Tuple<T_arrayLike extends Iterable<infer T_element> ? T_element : never, T_n>>;
export declare function chunksArrayLikeAsync<T_arrayLike extends MaybeAsyncIterable<any> & {
    length: number;
...
export declare function chunksArrayLikeAsync<T_arrayLike extends MaybeAsyncIterable<any>, T_n extends number>(arrayLike: T_arrayLike, n: T_n): AsyncGenerator<Tuple<T_arrayLike extends MaybeAsyncIterable<infer T_element> ? T_element : never, T_n>>;
