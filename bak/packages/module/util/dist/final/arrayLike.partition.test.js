...
// src/arrayLike.partition.ts
// @__NO_SIDE_EFFECTS__
async function partitionArrayLikeAsync(predicate, arrayLike) {
  const yes = [];
  const no = [];
...
__name(partitionArrayLikeAsync, "partitionArrayLikeAsync");

// src/arrayLike.partition.test.ts
...
//# sourceMappingURL=arrayLike.partition.test.js.map
