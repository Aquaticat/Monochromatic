...
function validate() {
  ...
  for (const text of ['D47', 'D48', 'one</strong> top bar', 'id="open-page"', 'id="back-player"', 'id="sample-query"', 'id="unavailable"', 'showStage(\'open-empty\')', 'showStage(\'player\')', 'preview.showModal()', 'await previewImage.decode()', 'returnTarget?.focus()', 'stepZoom(-0.25)', 'id="correction"']) {
