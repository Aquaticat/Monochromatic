...
// Rebuild only the chosen D51 A surface after D52 removed the redundant positive-results heading.
const root = process.env.MUSIC_PLAYER_REVIEW_ROOT;
if (!root) throw new Error('MUSIC_PLAYER_REVIEW_ROOT must name main design/questions directory.');
