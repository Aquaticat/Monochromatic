...
`package/git-policy/cli/perf/forbidden-strings-2026-07-10.json`.
...
`package/git-policy/cli/perf/manual-push-latency-benchmark.ts`.
Raw samples are stored in
`package/git-policy/cli/perf/manual-push-latency-2026-07-10.json`.
...
hyperfine 1.20.0.
 Main binary:
`/var/home/user/Monochromatic/package/cli/forbidden-strings/target/release/forbidden-strings`.
Experiment binary:
...
1.20.0,
 ...
 16 threads).
 Binary:
`package/cli/forbidden-strings/target/release/forbidden-strings` built
...
1.20.0,
 ...
 16 threads).
 Binary:
`package/cli/forbidden-strings/target/release/forbidden-strings` built from
...
(`./package/cli/forbidden-strings/src/rule/algebra_tests.rs:119:32..43 rule=849`,
...
- Repo content changed between benches:
  ...
  19.8 MiB.
   New content under `package/pi-plugin/auto-mode/src/` triggers
...
with `mise run //package/cli/forbidden-strings:build`.
...
FS=package/cli/forbidden-strings/target/release/forbidden-strings
