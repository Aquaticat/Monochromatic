...
This package lives under `package/agent-harness-shared/` because Pi spawn and
...
```sh
mise run //package/agent-harness-shared/session-discovery:test:unit
mise run //package/agent-harness-shared/session-discovery:lint
```
