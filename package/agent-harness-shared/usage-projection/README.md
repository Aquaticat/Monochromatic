...
```sh
mise run //package/agent-harness-shared/usage-projection:lint
mise run //package/agent-harness-shared/usage-projection:test:unit
mise run //package/agent-harness-shared/usage-projection:build
```
