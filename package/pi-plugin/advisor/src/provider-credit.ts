...
const CREDIT_EXHAUSTION_MARKERS = [
  'out of credits', 'insufficient credits', 'not enough credits',
  'credit balance is too low', 'credit balance exhausted', 'credits exhausted',
  'insufficient_credit', 'insufficient_balance', 'insufficient_quota', 'insufficient_g1_credits_balance',
] as const;
...
/**
 ...
 ```
 */
export function assertAdvisorProviderAvailable({ provider, blockedProviders, }: {
