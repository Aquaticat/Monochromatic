...
- **Framework**:
   h3 server with vanilla TypeScript client bundles and h-css runtime-generated styles.
...
Client pages use vanilla TypeScript bundles and h-css runtime-generated styles,
