...
**Goal**:
 Create `package/webapp-content/site-aquaticat/` containing only Aquaticat-specific content and config.

- [ ] Create `package/webapp-content/site-aquaticat/` with:
...
- [ ] Rename directory `package/ssg/aquati.cat/` to `package/webapp-content/ssg/`
