...
/**
 ...
 Run: mise run //package/dev-script/vm-builder:run
 */
...
/**
 ...
 sibling packages (e.g. `package/config/dotfiles/`).
 */
const MONOREPO_ROOT = await findRootCached({ marker: MISE_MONOREPO, },);
