 ...
 */
const SOURCE_MARKER = `${sep}package${sep}module${sep}make-asynchronous-fork${sep}src${sep}`;
...
/**
 ...
 @example
 ```ts
 isTarget('make-asynchronous.ts'); // => true
 ```
 */
...
/**
 ...
 @example
 ```ts
 packageRelative('file:///repo/package/module/make-asynchronous-fork/src/make-asynchronous.ts');
 // => 'make-asynchronous.ts'
 ```
 */
