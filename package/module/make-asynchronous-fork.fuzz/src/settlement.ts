/**
 ...
 two implementations' outcomes structurally without depending on error
 identity.
...
/**
 ...
 every other reason is carried raw for structural comparison.
 */
...
/**
 ...
 @example
 ```ts
 const settlement = await describeSettlement(wrapped({ args: [], }));
