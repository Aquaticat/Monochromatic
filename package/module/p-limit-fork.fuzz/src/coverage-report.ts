 ...
 */
const SOURCE_MARKER = `${sep}package${sep}module${sep}p-limit-fork${sep}src${sep}`;
...
/**
 ...
 @example
 ```ts
 packageRelative('file:///repo/package/module/p-limit-fork/src/p-limit.ts');
 // => 'parse.ts'
 ```
 */
