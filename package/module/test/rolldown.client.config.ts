...
import { clientConfig, type ClientFlavorConfig, } from '@monochromatic-dev/config-rolldown/.client.ts';
...
const config: ClientFlavorConfig = {
  ...clientConfig({ input: ['./src/sinon-browser-fixture.ts',], platform: 'browser', external: [], },),
