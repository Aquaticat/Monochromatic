/**
 ...
 unit suite; the `fuzz` task raises `P_MAP_FORK_FUZZ_RUNS` for a longer
 campaign.
...
const override = Number(process.env
  .P_MAP_FORK_FUZZ_RUNS,);

/**
 Number of fast-check runs per property. Set `P_MAP_FORK_FUZZ_RUNS` to
 override.
