 ...
 */
const SOURCE_MARKER = `${sep}package${sep}module${sep}p-map-fork${sep}src${sep}`;
...
/**
 ...
 @example
 ```ts
 packageRelative('file:///repo/package/module/p-map-fork/src/p-map.ts');
 // => 'parse.ts'
 ```
 */
