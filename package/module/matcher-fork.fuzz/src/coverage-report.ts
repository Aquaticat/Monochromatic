 ...
 */
const SOURCE_MARKER = `${sep}package${sep}module${sep}matcher-fork${sep}src${sep}`;
...
/**
 ...
 @example
 ```ts
 packageRelative('file:///repo/package/module/matcher-fork/src/matcher.ts');
 // => 'parse.ts'
 ```
 */
