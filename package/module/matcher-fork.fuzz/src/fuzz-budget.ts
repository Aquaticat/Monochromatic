/**
 ...
 unit suite; the `fuzz` task raises `MATCHER_FORK_FUZZ_RUNS` for a longer
 campaign.
...
const override = Number(process.env
  .MATCHER_FORK_FUZZ_RUNS,);

/**
 Number of fast-check runs per property. Set `MATCHER_FORK_FUZZ_RUNS` to
 override.
