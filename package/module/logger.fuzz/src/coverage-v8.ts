/**
 Raw V8 coverage reader for the module-logger fuzz coverage gate.
...
/**
 Path fragments that mark a `src` `.ts` file as a test (unit or browser)
...
/**
 ...
 @returns Target descriptor for `src` implementation files under `packageRoot`;
   otherwise an `other` marker for dependencies, this sidecar, and test files.
