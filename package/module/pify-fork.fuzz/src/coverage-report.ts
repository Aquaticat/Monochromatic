 ...
 */
const SOURCE_MARKER = `${sep}package${sep}module${sep}pify-fork${sep}src${sep}`;
...
/**
 ...
 @example
 ```ts
 packageRelative('file:///repo/package/module/pify-fork/src/pify.ts');
 // => 'parse.ts'
 ```
 */
