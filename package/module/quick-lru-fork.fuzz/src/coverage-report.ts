 ...
 */
const SOURCE_MARKER = `${sep}package${sep}module${sep}quick-lru-fork${sep}src${sep}`;
...
/**
 ...
 @example
 ```ts
 packageRelative('file:///repo/package/module/quick-lru-fork/src/quick-lru.ts');
 // => 'parse.ts'
 ```
 */
