/**
 ...
 unit suite; the `fuzz` task raises `QUICK_LRU_FORK_FUZZ_RUNS` for a longer
 campaign.
...
const override = Number(process.env
  .QUICK_LRU_FORK_FUZZ_RUNS,);

/**
 Number of fast-check runs per property. Set `QUICK_LRU_FORK_FUZZ_RUNS` to
 override.
