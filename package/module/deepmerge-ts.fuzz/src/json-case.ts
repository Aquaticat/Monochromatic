...
/**
 JSON value shape the corpus is restricted to.
 */
...
export const JSON_CASES: readonly JsonCase[] = [
  ...
  },
  {
    ...
    inputs: [{ r: { x: 1, y: 2, }, }, { r: { y: 3, z: 4, }, },],
    expected: { r: { x: 1, y: 3, z: 4, }, },
  },
  {
  ...
  {
    name: 'README example, JSON subset',
    inputs: [
      { record: { prop1: 'value1', prop2: 'value2', }, array: [1, 2, 3,], },
      { record: { prop1: 'changed', prop3: 'value3', }, array: [2, 3, 4,], },
    ],
    expected: {
      record: { prop1: 'changed', prop2: 'value2', prop3: 'value3', },
      array: [1, 2, 3, 2, 3, 4,],
    },
  },
];
