...
export class PreparationAttemptError extends Error {
   ...
   * ```
   */
  public constructor({ operation, dir, cause, }: {
    readonly operation: PreparationAttemptOperation;
    readonly dir: string;
    readonly cause?: unknown;
  },) {
    super(`Preparation attempt ${operation} failed at ${dir}. Inspect retained files; do not treat a partial namespace as a reviewed phase or retry a claimed acquisition.`,
