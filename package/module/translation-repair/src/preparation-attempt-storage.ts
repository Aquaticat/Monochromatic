...
export type PreparationAttemptStorage = {
  ...
  readonly write: (args: { readonly dir: string; readonly file: PreparationAttemptFile; readonly text: string; },) => Promise<void>;
};
 ...
 * ```
 */
async function write({ dir, file, text, }: { readonly dir: string; readonly file: PreparationAttemptFile; readonly text: string; },): Promise<void> {
...
export const preparationAttemptStorage: PreparationAttemptStorage = { allocate, write, };
