...
- DECLARED NAMES from the documents' front matter settle HOW to spell a name this passage already refers to, and a candidate using one has added nothing. They are not content this passage owes: a passage that does not refer to this person does not gain their name, and a line attributing the passage to someone ELSE never takes it.
