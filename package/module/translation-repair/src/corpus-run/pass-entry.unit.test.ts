...
await describe({
  ...
  children: [
    ...
    it({
      name:
        'settles an entry into ONE artifact at schema version 14 carrying BOTH lanes and absolute-reviewed '
      ...
      fn: async () => {
        ...
        expect((artifact as { artifactSchemaVersion: number; }).artifactSchemaVersion,).toBe(14,);
    ...
    it({
      ...
      fn: async () => {
        ...
        expect(artifact.artifactSchemaVersion,).toBe(14,);
