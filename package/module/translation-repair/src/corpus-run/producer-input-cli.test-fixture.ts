 ...
 * ```
 */
export function inputCli({ fixture, arguments_, }: { readonly fixture: InputCliFixture; readonly arguments_: readonly string[]; },): SpawnSyncReturns<string> {
  return spawnSync(process.execPath, [fixture.executable, ...arguments_], {
 ...
 * ```
 */
export async function inputLaunchArguments({ fixture, bytes, }: { readonly fixture: InputCliFixture; readonly bytes: Uint8Array; },): Promise<readonly string[]> {
