/**
 * Tests for the one check a cached slice record can be held to on its own.
 *
 * Both lanes store a decided text beside a boolean saying whether it differs
 * from the archive's, and nothing but this compares them. A record that
 * contradicts itself is not a model failure: it is a file, and files get
 * truncated, hand-edited, and written under a slicing that has since moved.
 *
