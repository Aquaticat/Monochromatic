...
- Zero runtime dependencies and house-style ownership of a stable syntax module (no regex
  ...
  TSDoc), per `docs/decisions/stable-syntax-modules.md`.
...
- `docs/handover/jsonc-edit.md`:
  living implementation status.
- `docs/decisions/stable-syntax-modules.md`:
...
- `docs/troubleshooting/c-like-comments.md`:
