...
- `packages/fuzz/forbidden-strings/README.md` and `docs/handover/forbidden-strings-fuzzing.md`
...
The constraints in `docs/decisions/dist-in-git.md` stand unchanged:
