...
See `docs/dependency-blocklist.md` for the mechanism reference,
 the decision
...
kept instead because its message points at `docs/dependency-blocklist.md`,
 which is more
...
error.
 See `docs/troubleshooting/stryker-container-runtime.md` for the Stryker runtime
...
at `docs/dependency-blocklist.md`,
