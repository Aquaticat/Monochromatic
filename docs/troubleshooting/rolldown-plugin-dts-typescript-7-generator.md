...
- Rebuilt config-oxlint,
  stylistic,
  and module-const artifacts had no Git diff from the tracked Oxc-generated outputs.
...
kept generated bytes unchanged,
...
6. **Have we prototyped a minimal fix compatible with their architecture?**
   ...
   type-checked,
   linted,
   and compared against tracked generated bytes.
