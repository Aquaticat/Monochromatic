...
- UI strings bundle at `packages/webapp-content/ssg-test/src/i18n/ca/index.ts`,
...
- Build a glossary of recurring technical terms (button,
   ...
   Promote the glossary into a doc under `docs/` so future translators have a reference.
