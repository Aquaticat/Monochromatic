...
Scope: `packages/oxlint-plugins/prefer-readonly-parameter-type` and every consuming package.
Rollout: big-bang;
...
- Known modeling gap:
  ...
  (`docs/handover/file-manager-sticky-prototypes.md`).
...
- docs updated:
  plugin README,
  `docs/troubleshooting/oxlint-prefer-readonly-foreign-provenance.md`,
  `docs/troubleshooting/oxlint-prefer-readonly-host-intrinsic-evidence.md`.
