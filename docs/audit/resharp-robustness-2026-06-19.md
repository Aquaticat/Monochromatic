...
audit trail (`docs/troubleshooting/resharp.md`,
 `docs/audit/resharp-fuzz-*`,
`docs/handover/resharp-*`),
...
`docs/audit/resharp-fuzz-2026-06-19/`,
...
- One architectural restriction is permanent by design:
  ...
  `engine::lookaround_in_complement`.
   See `docs/troubleshooting/resharp.md`.
