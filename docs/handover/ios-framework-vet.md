...
Status as of 2026-06-13 (fifth handover):
 ...
 not
just enumerated,
 in two new reports under `../decisions/ios-iphone-x-vet-reports/`.
...
(`docs/decisions/kotlin-android-kopia-pcloud-stack.md`):
 clone,
 source-audit,
 build,
 and run on the
...
Full procedure:
 `docs/runbook/ios-iphone-x-codesign-setup.md`.
 Reusable:
...
functional requirements,
 ...
 Output:
 16
`docs/decisions/ios-iphone-x-vet-reports/vet-<fw>.md` (verbatim,
