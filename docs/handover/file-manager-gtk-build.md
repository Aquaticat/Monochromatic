...
- 2026-07-08: Labeled debug tint pass. User clarified that the green pane bodies were misleading and
  ...
  shared lane, `P4N` fixed-height pane shell, `H7D` pane header bar, and `B6P` preview body. Removed
  the green list/body fill; list viewport and realized-row labels are intentionally disabled while
