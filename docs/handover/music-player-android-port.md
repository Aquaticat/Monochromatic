...
yet.
 The authoritative decision record is `docs/decisions/music-player-android-port.md`;
 read it first.
 This
...
`docs/decisions/music-player-{session-source-root,jit-shuffle,live-update-rescan}.md`,
