...
The rejected alternative was a hybrid:
 ...
 audit,
 handover)
into `docs/` but keep the constitution (`AGENTS.md`,
 `CLAUDE.md`,
...
nicety,
 ...
 and `rg docs/philosophy` reaches it as fast as a root listing did.
...
A bare `PREFIX.md` index becomes `docs/<family>/README.md`,
...
A troubleshooting patch is `docs/troubleshooting/<topic>.patch`,
