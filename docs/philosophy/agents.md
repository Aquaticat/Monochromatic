...
- 2026-06-06: Removed SEC from AGENTS.md because it was generic security guidance; the section now keeps the
  syntax-boundary rules with specific project behavior.
