...
- 2026-06-05: Removed AGENTS.md `RT5` because the web-search package-internals reminder was common sense and duplicated clone/source-investigation rules (`CLN`, `TP5`).
