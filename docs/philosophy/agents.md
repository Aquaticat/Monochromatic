...
- 2026-06-06: Merged CL2 into CLG, keeping the combined `cli-git` bypass and scoped pathspec guidance under
  100 words while preserving both rules' constraints.
