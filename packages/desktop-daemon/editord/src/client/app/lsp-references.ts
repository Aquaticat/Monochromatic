...
import type { ReferenceLocation, ReferencesPopup, } from '../references/references-popup.ts';
 ...
 */
export async function showReferences({ ws, referencesPopup, getCurrentFilePath, line, character, rect, }: {
  ws: EditorWsClient;
