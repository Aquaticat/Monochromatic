...
```bash
COSIGN_PASSWORD="" cosign sign --key packages/config/cosign/cosign.key IMAGE_REF
```

## Verifying an image

```bash
cosign verify --key packages/config/cosign/cosign.pub IMAGE_REF
```
