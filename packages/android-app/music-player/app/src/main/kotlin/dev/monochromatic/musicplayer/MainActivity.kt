...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Scaffold below apply the system-bar insets, instead of letting content
        // render under the status and gesture bars.
        enableEdgeToEdge()
        setContent {
...
fun PlayerScreen() {
    ...
    Scaffold(
        topBar = {
            TopAppBar(title = { Text("Music Player (${BuildConfig.FLAVOR})") })
        },
    ) { innerPadding ->
        Column(
            modifier = Modifier
