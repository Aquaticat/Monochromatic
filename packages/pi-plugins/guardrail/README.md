...
{
  "packages": [
    "/var/home/user/Monochromatic/packages/pi-plugins/guardrail"
  ]
}
```
...
```sh
mise run //packages/pi-plugins/guardrail:build
mise run //packages/pi-plugins/guardrail:test:unit
mise run //packages/pi-plugins/guardrail:lint
mise run //packages/pi-plugins/guardrail:verify:extension
```
