...
```sh
mise run //packages/git-policies/forbidden-strings:build
mise run //packages/git-policies/forbidden-strings:test:unit
mise run //packages/git-policies/forbidden-strings:lint
```
