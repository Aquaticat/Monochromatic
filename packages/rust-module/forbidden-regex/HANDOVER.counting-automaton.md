...
mirrors `packages/fuzz/forbidden-strings`;
...
- Package:
   `packages/rust-module/forbidden-regex/`,
   crate `forbidden_regex`,
  edition 2024.
   New `packages/rust-module/` category for Rust library crates.
...
sidecar (`packages/rust-module/forbidden-regex.bench`),
 on two machines,
 measured
