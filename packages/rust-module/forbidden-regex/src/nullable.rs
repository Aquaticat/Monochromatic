...
/// the anchors consult the context. Why: a string is accepted exactly when the
/// residual after consuming it is nullable, so this is the acceptance test the
/// matcher and DFA builder both rely on.
