...
exec node "$basedir/../../packages/git-policy/cli/dist/final/node/index.mjs" "$@"
# cmd-shim-target=/var/home/user/Monochromatic/packages/git-policy/cli/dist/final/node/index.mjs
`;
