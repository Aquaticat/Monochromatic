...
```sh
mise run //packages/git-policy/cli:test:built:trust
```
...
```console
mise run //packages/git-policy/cli:perf:lifecycle-latency
```
...
`packages/git-policy/cli/dist/final/node/index.mjs`,
