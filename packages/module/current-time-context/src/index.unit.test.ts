...
import { formatTimeContext, } from './index.ts';
      ...
      children: [
        it({
          ...
          fn: async function testSingleDigitHourAndMinute() {
            expect(formatTimeContext(new Date(2_026, 4, 1, 7, 5,),),)
        ...
        it({
          ...
          fn: async function testMidnight() {
            expect(formatTimeContext(new Date(2_026, 4, 1, 0, 0,),),)
        ...
        it({
          ...
          fn: async function testTypicalEveningTime() {
            expect(formatTimeContext(new Date(2_026, 4, 1, 20, 48,),),)
        ...
        it({
          ...
          fn: async function testLastMinuteOfDay() {
            expect(formatTimeContext(new Date(2_026, 4, 1, 23, 59,),),)
