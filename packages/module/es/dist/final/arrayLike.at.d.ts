import { type Ints, type IntsNegative22to22, type MaybeAsyncIterable, type Negative } from '@monochromatic-dev/module-es/ts';
 ...
 */
export declare function atArrayLikeAsync<const T_arrayLike extends readonly any[], T_index extends Ints<Negative<T_arrayLike['length']>, T_arrayLike['length']>>(index: T_index, arrayLike: T_arrayLike): Promise<T_index extends IntsNegative22to22 ? T_arrayLike[T_index] : T_arrayLike[number] | undefined>;
