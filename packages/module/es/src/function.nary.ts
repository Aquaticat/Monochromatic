/* @__NO_SIDE_EFFECTS__ */ export function unary<T_param1,
  T_fn extends (param1: T_param1, ...otherParams: any[]) => any,>(
  fn: T_fn,
...
/* @__NO_SIDE_EFFECTS__ */ export function binary<T_param1, T_param2,
  T_fn extends (param1: T_param1, param2: T_param2, ...otherParams: any[]) => any,>(
  fn: T_fn,
...
/* @__NO_SIDE_EFFECTS__ */ export function ternary<T_param1, T_param2, T_param3,
