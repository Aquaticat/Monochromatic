...
import type { Logged, } from '../logged/logged.basic';
 ...
 */
export function createArrayful<
  const TArray extends readonly unknown[] = readonly unknown[],
  TOriginal extends object = UnknownRecord,
>(
  ...
  return Object.assign(obj, { array,
    [Symbol.iterator]: array[Symbol.iterator], },) as any;
}
