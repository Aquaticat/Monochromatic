...
describe('toExport', () => {
  ...
  describe('collection types', () => {
    test('converts Set values', () => {
      ...
      expect(toExport(new Set(['a', 'b']))).toBe('Object.freeze(new Set(["a","b"]))');
    ...
    test('converts Map values', () => {
      ...
      expect(toExport(map3)).toBe('Object.freeze(new Map([[true,false],[false,true]]))');
    });
    ...
    test('converts Object values', () => {
      ...
      const obj1 = { a: 1, b: 2 };
      expect(toExport(obj1)).toBe('Object.freeze(Object.fromEntries([["a",1],["b",2]]))');
