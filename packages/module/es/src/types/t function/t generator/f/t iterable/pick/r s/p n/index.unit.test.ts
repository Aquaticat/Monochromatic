...
describe($, () => {
  ...
  test('returns empty when inclusion set is empty', () => {
    const numbers = [1, 2, 3,];
  ...
  test('returns all items when all are in inclusion set', () => {
    const numbers = [1, 2, 3,];
  ...
  test('throws when toPick contains items not in the iterable', () => {
    const numbers = [1, 2, 3,];
  ...
  test('does not throw when strict is false and toPick contains missing items', () => {
    const numbers = [1, 2, 3,];
    const toPick = new Set([2, 4, 5,],);
  ...
  test('strict: false returns only existing items from toPick', () => {
    const words = ['apple', 'banana', 'cherry',];
  ...
  test('strict: false with all missing keys returns empty array', () => {
    const numbers = [1, 2, 3,];
  ...
  test('preserves order of items from iterable', () => {
