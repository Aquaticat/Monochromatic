...
describe($$, () => {
  ...
  test('handles complex selectors', () => {
    expect($({ rule: '.card > .title:first-child', decls: { 'font-weight': 'bold', }, }),).toBe(
  ...
  test('creates a @font-face rule', () => {
    ...
    }),).toBe('@font-face{font-family:"Aquaticat";src:url("aquaticat.woff2") format("woff2");font-display:swap}',);
  });
