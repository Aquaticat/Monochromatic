...
export declare const fs: Readonly<{
    ...
    } & import("events").Abortable) | null | undefined) => ReturnType<typeof fsWriteFile>;
    cpFile: (src: import("fs").PathLike, dest: import("fs").PathLike, mode?: number | undefined) => ReturnType<typeof fsCopyFile>;
