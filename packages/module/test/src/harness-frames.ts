 ...
 * (`packages/module/test/src/`) and the `node_modules` form
 ...
 * @example
 * ```ts
 * isTestFileFrame('at fn (packages/foo/src/a.unit.test.ts:9:1)') // true
 * isTestFileFrame('at fn (packages/module/test/src/it.ts:9:1)')  // false
 * ```
 */
 ...
 * @example
 * ```ts
 * isHarnessInternalFrame('at toBe (packages/module/test/src/expect-matchers-core.ts:70:10)') // true
 * isHarnessInternalFrame('at fn (packages/module/test/src/it.unit.test.ts:21:12)')           // false
 * isHarnessInternalFrame('at userFn (packages/foo/src/bar.ts:9:19)')                         // false
 * ```
 */
