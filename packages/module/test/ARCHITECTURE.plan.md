...
- `packages/module/test/src/format-error.ts`
- `packages/module/test/src/assertion-source.ts`
- `packages/module/test/src/harness-frames.ts`
- `packages/module/test/src/index.ts`
- `packages/module/test/src/*.unit.test.ts`
...
```ts
// packages/module/test/src/failure-reporter.ts
...
- `mise run //packages/module/test:buildAndTest` passes.
