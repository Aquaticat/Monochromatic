    ...
    () =>
      describe({
        ...
        children: [
          ...
          () =>
            it({
              name: '5-deep chain returns the latest revision of edited chunks and the original of unedited ones',
              fn: async () => {
    ...
    () =>
      describe({
        ...
        children: [
          ...
          () =>
            it({
              name: 'caps revisions at MAX_REVISIONS and returns "capped" on the next attempt',
              fn: async () => {
