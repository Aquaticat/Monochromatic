...
async function getTaskRowById(id: string): Promise<TaskRow | null> {
  // oxlint-disable-next-line @typescript-eslint/no-unsafe-type-assertion -- database prepare().get() returns the row shape we defined
...
export async function listInboxUnblockedTasks(): Promise<Task[]> {
  // oxlint-disable-next-line @typescript-eslint/no-unsafe-type-assertion -- database query returns TaskRow shape
...
export async function listBlockedInboxTasks(): Promise<BlockedTaskLink[]> {
  // oxlint-disable-next-line @typescript-eslint/no-unsafe-type-assertion -- database query returns TaskRow with blocker_id join column
...
export async function listAllTags(): Promise<string[]> {
  // oxlint-disable-next-line @typescript-eslint/no-unsafe-type-assertion -- database query returns rows with tag column
...
export async function searchTasks(searchQuery: string): Promise<SearchTask[]> {
  ...
  try {
    // oxlint-disable-next-line @typescript-eslint/no-unsafe-type-assertion -- database FTS query returns TaskRow with is_blocked column
    ...
    // oxlint-disable-next-line @typescript-eslint/no-unsafe-type-assertion -- database LIKE query returns TaskRow with is_blocked column
    const rows = await db
...
export async function completeTask(id: string): Promise<CompleteTaskResult> {
  ...
  // oxlint-disable-next-line @typescript-eslint/no-unsafe-type-assertion -- database query returns blocker join columns
