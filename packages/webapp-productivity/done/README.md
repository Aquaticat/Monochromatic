...
4. **Database** -- SQLite (bun:sqlite) with FTS5 full-text search, initialized via side-effect import at startup
...
That is worse than consistently using raw `bun:sqlite` everywhere.
