...
// TS map:   `import type { RgbColor } from "libghostty-vt/style"`.
//
...
// TS map:   `{ red: number, green: number, blue: number }`.
//
// In TS you'd write (pseudocode):
// ```ts
...
// TS map:   `type Rgb = { red: number; green: number; blue: number }`.
//
// In TS you'd write (pseudocode):
// ```ts
// type Rgb = { red: number; green: number; blue: number };
...
// TS map:   `function fromGhosttyRgb(color: RgbColor): Rgb`.
//
// In TS you'd write (pseudocode):
// ```ts
...
impl From<RgbColor> for Rgb {
    ...
    // TS map:   `return { red: color.r, green: color.g, blue: color.b }`.
    //
    // In TS you'd write (pseudocode):
    // ```ts
    // return { red: color.r, green: color.g, blue: color.b };
...
// TS map:   `type TerminalCell = { row, col, text, foreground, background, ... }`.
//
// In TS you'd write (pseudocode):
// ```ts
// type TerminalCell = {
...
// TS map:   `type TerminalSnapshot = { cells: TerminalCell[], ... }`.
//
// In TS you'd write (pseudocode):
// ```ts
