...
const hasBuildJs = Array.from(new Set([hasBabel, hasEsbuild, hasVite, hasTypescript].flat()));
...
const hasBuildHtml = Array.from(new Set([hasBuildJs, hasPostHtml, hasVue, hasUnified, hasDom].flat()));
...
const hasBuild = Array.from(new Set([hasBuildJs, hasBuildCss, hasBuildHtml, hasBuildImg].flat()));
