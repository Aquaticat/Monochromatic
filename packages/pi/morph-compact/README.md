...
When pi's context window fills up and compaction triggers, this extension intercepts the `session_before_compact` event and calls the Morph Compact API instead of pi's default LLM summarization.
