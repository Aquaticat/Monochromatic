...
import type { BashAnalysis, SignalContext, } from "./types.ts";
import {
  bashSignals,
  type CommandMatcher,
  hasFlag,
...
await describe({
  ...
  children: [
    ...
    it({
      ...
      fn: async () => {
        expect(pathSignals("/var/home/user/other-project/file", DEFAULT_CTX,)).toBe(true,);
      },
    },),
...
await describe({
  ...
  children: [
    it({
      ...
      fn: async () => {
        expect(isHomeDotfile("/var/home/user/.ssh/authorized_keys", "/var/home/user",)).toBe(true,);
      },
    },),
    ...
    it({
      ...
      fn: async () => {
        expect(isHomeDotfile("/var/home/user/project/file", "/var/home/user",)).toBe(false,);
      },
    },),
  ],
},);
