...
export type ComputedColor = `rgb(${number}, ${number}, ${number})` | `rgba(${number}, ${number}, ${number}, ${number})`;
...
export type AuthoredCss = AuthoredCssBoolean | AuthoredCssInvalid | AuthoredCssString | AuthoredCssNumber | AuthoredCssColor | AuthoredCssBoxShadow;
