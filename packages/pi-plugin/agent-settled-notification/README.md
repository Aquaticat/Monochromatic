...
{
  "packages": [
    "/var/home/user/Monochromatic/packages/pi-plugin/agent-settled-notification"
  ]
}
```
...
```sh
mise run //packages/pi-plugin/agent-settled-notification:build
mise run //packages/pi-plugin/agent-settled-notification:lint
mise run //packages/pi-plugin/agent-settled-notification:test:unit
mise run //packages/pi-plugin/agent-settled-notification:verify:extension
mise run //packages/pi-plugin/agent-settled-notification:verify:pi-runtime
```
