...
/**
 * Core tool title entries for file, search, and agent tools.
 * Combined with {@link EXTENDED_TOOL_TITLES} and {@link SEARCH_TOOL_TITLES}
 * to form the full {@link TOOL_TITLES} registry.
 */
