 ...
 * `@monochromatic-dev/claude-code-plugin-source/handler/bash-output-filter/filter`.
...
import {
  runFilter,
} from '@monochromatic-dev/claude-code-plugin-source/handler/bash-output-filter/filter';
