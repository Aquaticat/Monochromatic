...
mise run //packages/kwin/key-helper:install
```
...
mise run //packages/kwin/key-helper:run

# Run with file-watch auto-restart.
mise run //packages/kwin/key-helper:run:dev

# Unit tests for the pure logic.
mise run //packages/kwin/key-helper:test:unit
```
