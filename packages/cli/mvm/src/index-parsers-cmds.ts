...
export const createCmd = command('create', map(
...
export const shellCmd = command('shell', map(
...
export const listCmd = command('list', map(
  object({},),
...
export const lsCmd = command('ls', map(
  object({},),
...
export const runCmd = command('run', map(
  object({
    from: fromOption,
...
export const updateCmd = command('update', map(
  object({},),
