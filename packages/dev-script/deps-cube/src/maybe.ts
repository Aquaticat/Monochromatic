/**
 * Shared "value or absent" sentinel for the deps-cube pipeline.
 *
 ...
 * in-memory function returns only. Persisted shapes (cache files,
 * `window.__PROBES__`) keep using optional properties.
 *
 * @example
 * ```ts
