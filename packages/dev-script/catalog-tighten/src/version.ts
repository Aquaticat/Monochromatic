/**
 * Semver parsing and version resolution utilities for catalog-tighten.
 *
 * Handles `>=` range extraction, semver comparison, npm alias resolution,
 * and installed version lookup across node_modules, workspace roots,
 * and the Bun store.
 */
