...
<CalloutAlert data-type="tip">Optional information to help a user be more successful.</CalloutAlert>

<CalloutAlert data-type="important">Crucial information necessary for users to succeed.</CalloutAlert>

<CalloutAlert data-type="warning">Critical content demanding immediate user attention due to potential risks.</CalloutAlert>

<CalloutAlert data-type="caution">Negative potential consequences of an action.</CalloutAlert>
