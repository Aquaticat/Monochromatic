      ...
      children: [
        ...
        it({
          ...
          fn: async () => {
            ...
            completeSchema.push(...encodeVarInt(0)); completeSchema.push(0); completeSchema.push(...encodeVarUint(1));
            ...
            completeSchema.push(...encodeVarInt(0)); completeSchema.push(0); completeSchema.push(...encodeVarUint(0));
            ...
            completeSchema.push(...encodeVarInt(0)); completeSchema.push(0); completeSchema.push(...encodeVarUint(2));
            ...
            for (const n of ["m00", "m01", "m02", "m10", "m11", "m12"]) {
              ...
              completeSchema.push(...encodeVarInt(-5)); completeSchema.push(0); completeSchema.push(...encodeVarUint(0));
            }
            ...
            completeSchema.push(...encodeVarInt(-4)); completeSchema.push(0); completeSchema.push(...encodeVarUint(1));
            completeSchema.push(...encodeString("localID"));
            completeSchema.push(...encodeVarInt(-4)); completeSchema.push(0); completeSchema.push(...encodeVarUint(2));
            ...
            completeSchema.push(...encodeVarInt(-6)); completeSchema.push(0); completeSchema.push(...encodeVarUint(2));
            ...
            completeSchema.push(...encodeVarInt(2)); completeSchema.push(0); completeSchema.push(...encodeVarUint(4));
            completeSchema.push(...encodeString("name"));
            completeSchema.push(...encodeVarInt(-6)); completeSchema.push(0); completeSchema.push(...encodeVarUint(5));
            ...
            completeSchema.push(...encodeVarInt(-4)); completeSchema.push(0); completeSchema.push(...encodeVarUint(3));
            // tag 4: nodeChanges (repeated NodeChange)
            completeSchema.push(...encodeString("nodeChanges"));
            completeSchema.push(...encodeVarInt(6)); completeSchema.push(1); completeSchema.push(...encodeVarUint(4));
