...
import { SEVERITY_MAP, normalizeMessage } from "./nvim-client.ts";
...
describe("normalizeMessage", () => {
  test("reformats embedded help text inline", () => {
    expect.assertions(1);
    expect(normalizeMessage("Empty exports do nothing in module files\nhelp: Remove this empty export."))
      .toBe("Empty exports do nothing in module files (help: Remove this empty export.)");
  });
